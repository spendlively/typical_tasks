...
2. Требования
 ...
 - Куки сохраняются после закрытия браузера
 - Автологин опционально
 - Данные сессии должны быть доступны на различных устройствах
 - Пользователь должен иметь возможность разлогиниться

Если пользователь
  - залогинился
нужно перегенирить сессионную куку - session_regenerate_id()